        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <div className="space-y-6 text-[16px] font-mono leading-relaxed text-text-primary">
              <p>
                Hi, I&apos;m Ganesh — a <span className="text-text-cyan font-bold underline decoration-text-cyan/30">Full Stack Developer</span> from West Bengal, India. I specialize in building highly scalable web architectures and immersive mobile experiences.
              </p>
              <p>
                My philosophy is centered around <span className="text-text-orange font-semibold">"Antigravity Code"</span> — writing logic that feels weightless, performant, and perfectly balanced between frontend elegance and backend robustness.
              </p>
              <p>
                Currently, I am focused on bridging the gap between <span className="text-text-purple font-semibold">IoT ecosystems</span> and <span className="text-text-green font-semibold">AI automation</span>, creating systems that solve complex real-world problems with simple, intuitive interfaces.
              </p>
            </div>
          </section>
